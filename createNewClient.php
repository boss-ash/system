...
<div class="container my-5">
    ...
    <form method="POST">
        ...
        <div class="row mb-3">
            <label class="col-sm-3 col-form-label">Type Of Costumer</label>
            <div class="col-sm-6">
                <select class="form-control" name="vehicle_type">
                    <option value="0">SELECT STATUS TYPE</option>
                    <option value="4wheels" <?php echo $vehicle_type === '4wheels' ? 'selected' : ''; ?>>VIP</option>
                    <option value="2wheels" <?php echo $vehicle_type === '2wheels' ? 'selected' : ''; ?>>REGULAR</option>
                </select>
            </div>
        </div>
        <div class="row mb-3">
            ...
            <div class="col-sm-6">
                <select class="form-control" name="vehicle_type">
                    ...
                    <option value="2wheels" <?php echo $vehicle_type === '2wheels' ? 'selected' : ''; ?>>6 wheeler</option>
                </select>
            </div>
        </div>
        <div class="row mb-3">
        ...
        <div class="row mb-3">
            ...
            <div class="col-sm-6">
                <input type="time" class="form-control" name="time" value="<?php echo htmlspecialchars($date); ?>">
            </div>
        </div>
